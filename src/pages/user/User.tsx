        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-8">
          ...
          {!productData ? (
            <div className="text-center py-12">
              ...
              <p className="text-white/60 mb-6">
                You haven't purchased any products. Browse our store to get started!
              </p>
              <div
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold mb-1">T-38C Talon</h3>
                    <p className="text-white/60 text-sm">Microsoft Flight Simulator 2024</p>
                  </div>
                  ...
                  {productData.purchased_at && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-white">
                        {new Date(productData.purchased_at).toLocaleDateString()}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex gap-3">
                  <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors text-sm font-semibold">
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mt-6">
                ...
                <ol className="text-sm text-white/80 space-y-2 ml-6 list-decimal">
                  <li>Download the aircraft package using the button above</li>
