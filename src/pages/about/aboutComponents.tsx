 ...
 * @param {JSX.Element} icon - The icon for the AboutComponent
 ...
 */
export const AboutComponent = ({ title, icon, colors, dotSize = 2 }: AboutProps): JSX.Element => {
  return (
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-4 relative h-[30rem] "
    >
...
type T_IconsProps = {
  type: 'leptos' | 'rust' | 'airplane' | 'folder' | 'sync' | 'fragment'
  className?: string
}

export const Icons: FC<T_IconsProps> = (props: T_IconsProps): JSX.Element => {
  const getIcon = (): JSX.Element => {
    switch (props.type) {
      case 'leptos':
        return (
          <svg xmlns="http://www.w3.org/2000/svg"  id="Layer_1" x="0" y="0"version="1.1" viewBox="0 0 116 116"><path id="path6" d="M81.9 15c3.7 0 6.9-2.1 8.5-5.1-5.3-3.6-11.3-6.3-17.6-8-.4 1.1-.6 2.2-.6 3.4 0 5.3 4.4 9.7 9.7 9.7z" fill="#ef3b39"/><circle id="circle10" cx="58" cy="58" r="22.4" fill="#ef3b39"/><path id="path12" d="M78.3 21c1.2.3 2.4.4 3.7.4 5.7 0 10.8-3 13.6-7.6-1.6-1.4-3.3-2.7-5.1-3.9-1.7 3-4.9 5.1-8.5 5.1-5.4 0-9.7-4.4-9.7-9.7 0-1.2.2-2.3.6-3.4-2.1-.5-4.2-1-6.3-1.3-.4 1.5-.7 3-.7 4.7 0 4.3 1.7 8.2 4.4 11-3.3 3.9-5.9 8.4-7.9 13.2-1.4-.2-2.9-.3-4.4-.3-15.9 0-28.8 12.9-28.8 28.8 0 13.2 8.9 24.3 21 27.7-3.9 9.9-11.5 18-21 22.6 2.3 1.3 4.6 2.5 7.1 3.4 9.4-5.7 16.7-14.5 20.4-25h1.4c15.9 0 28.8-12.9 28.8-28.8 0-12.2-7.6-22.6-18.2-26.8 1.7-4.1 4-7.9 6.9-11.2.8.5 1.7.8 2.7 1.1zm2.1 37c0 12.4-10.1 22.4-22.4 22.4-12.4 0-22.4-10.1-22.4-22.4 0-12.4 10.1-22.4 22.4-22.4 12.4 0 22.4 10 22.4 22.4z" fill="white"/></svg>
        )
      case 'rust':
        return (
