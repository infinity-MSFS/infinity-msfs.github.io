          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/70 text-sm">
                Learn how the Infinity Manager works and integrate your aircraft
                into our ecosystem with our comprehensive developer
                documentation.
              </p>
            </div>
            <a
              href="https://docs.infinity-simulations.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 px-8 py-4 rounded-lg bg-gradient-to-r from-blue-500/10 to-purple-500/10 hover:from-blue-500/20 hover:to-purple-500/20 transition-all border border-blue-500/20 hover:border-blue-500/40 hover:shadow-lg hover:shadow-blue-500/20"
            >
              <svg
